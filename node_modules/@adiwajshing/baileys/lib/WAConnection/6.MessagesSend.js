...
class WAConnection extends _5_User_1.WAConnection {
        ...
        switch (type) {
            ...
            case Constants_1.MessageType.extendedText:
                ...
                if ('text' in message) {
                    ...
                    m.extendedTextMessage = Constants_1.WAMessageProto.ExtendedTextMessage.create(message);
                }
                else {
            ...
            case Constants_1.MessageType.liveLocation:
                m.locationMessage = Constants_1.WAMessageProto.LocationMessage.create(message);
                break;
            case Constants_1.MessageType.contact:
                m.contactMessage = Constants_1.WAMessageProto.ContactMessage.create(message);
                break;
    ...
    async prepareMessageMedia(buffer, mediaType, options = {}) {
        ...
        const message = {
            [mediaType]: Constants_1.MessageTypeProto[mediaType].create({
                url: mediaUrl,
                mediaKey: mediaKey,
        ...
        return Constants_1.WAMessageProto.Message.create(message); // as WAMessageContent
    }
    ...
    prepareMessageFromContent(id, message, options) {
        ...
        message = Constants_1.WAMessageProto.Message.create(message);
        const messageJSON = {
            key: {
                remoteJid: id,
                fromMe: true,
    ...
    async relayWAMessage(message) {
        ...
        message.status = Constants_1.WA_MESSAGE_STATUS_TYPE.SERVER_ACK;
